...
[Forks play a critical role in the evolution and growth of blockchain technologies](https://www.nervos.org/zh/knowledge-base/What_are_implications_of_forks). They act as catalysts for change, allowing the implementation of new features, enhancements, and adjustments to the cryptocurrency's protocol. Forks are often the outcome of disagreements over embedded characteristics within the crypto community, which can lead to substantial changes in the course of the cryptocurrency.
