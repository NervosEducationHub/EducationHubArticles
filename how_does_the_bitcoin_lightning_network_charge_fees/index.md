...
Traditional Bitcoin transactions must be confirmed by [miners](https://www.nervos.org/knowledge-base/difference_between_crypto_miners_validators) and recorded on the blockchain, a process that can take minutes to hours and is costly during periods of network congestion. Lightning sidesteps this by keeping most interactions off‑chain, as only the opening and closing of a channel require on-chain transactions.
