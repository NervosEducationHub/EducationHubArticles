...
category: Nervos, Modular, guide, state, utxo, scaling
...
One strand of thinking that has become popular in crypto land recently is that the only way for blockchains to solve the [Scalability Trilemma](https://www.nervos.org/knowledge-base/blockchain_trilemma)—or obtain the trifecta of high security, decentralization, and scalability—is to adopt a layered or [modular architecture](https://www.nervos.org/knowledge-base/modular_vs_monolithic). 
