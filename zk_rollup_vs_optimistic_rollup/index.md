...
Rollups are powerful blockchain scaling solutions that have become very popular over the last two years. There are two types of rollups: zero-knowledge rollups (ZK-rollups) and [Optimistic rollups](https://www.nervos.org/knowledge-base/what_are_optimistic_rollups_and_how_do_they_work), which serve the same purpose but function differently.
