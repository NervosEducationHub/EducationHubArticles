...
All the technical communication—requesting, validating, and confirming—takes place behind the scenes. The result is a streamlined experience with no need to manually copy or paste invoice codes.

### Main Types of LNURL

LNURL isn’t just for sending money. It has several sub-protocols for different tasks:

- **LNURL-pay**: Simplifies receiving payments. A merchant or creator can display a single static QR code that supports multiple or repeated transactions—ideal for online tipping, donations, or recurring purchases.
